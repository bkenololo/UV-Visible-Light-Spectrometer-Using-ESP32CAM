...
def ambil_gambar_serial(port="/dev/tty.usbserial-110", baudrate=115200, timeout=10):
    ser = serial.Serial(port, baudrate, timeout=timeout)
    time.sleep(2)  # Tunggu ESP32 ready

    # Kirim perintah ambil gambar
    ser.write(b'c')
...
def main():
    #ip_esp32 = "192.168.1.16"  # Ganti sesuai IP ESP32-CAM kamu
    frame = ambil_gambar_serial(port="/dev/tty.usbserial-110") 
